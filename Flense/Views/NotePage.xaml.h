...
namespace winrt::Flense::implementation
{
    struct NotePage : NotePageT<NotePage>
    {
        ...
        winrt::fire_and_forget SaveCloseButton_Click(winrt::Microsoft::UI::Xaml::Controls::SplitButton const& sender, winrt::Microsoft::UI::Xaml::Controls::SplitButtonClickEventArgs const& args);
